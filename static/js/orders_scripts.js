window.onload = function () {
    ...
    // Подсчет колличества и стоимости, при отсутствии данных на странице(например при создании нового заказа)
...
//    });
    ...
    // Функция обновления статистики заказа
    ...
    //асинхронное добовление цен, через AJUX
